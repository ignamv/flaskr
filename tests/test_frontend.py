...
class RegisterPage(PageObject):
    ...
    def register(self, username, password):
        clear_and_send_keys(self.webdriver.find_element(By.NAME, 'username'),
                            username)
        clear_and_send_keys(self.webdriver.find_element(By.NAME, 'password'),
                            password)
...
class NewOrEditPostPage(PageObject):
    ...
    def submit(self, title, body, tags):
        clear_and_send_keys(self.webdriver.find_element(By.NAME, 'title'),
                            title)
...
def find_posts(webdriver):
    return [
        ...
        for elem in webdriver.find_elements(By.XPATH,
                                            '//article[@class="post"]')
    ]
